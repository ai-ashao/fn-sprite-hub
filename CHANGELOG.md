...
- Added four collection-state image exports—My Collection, Missing, Unmastered, and Mastered—as
  single 1080px-wide PNGs with dynamic height; empty image types are disabled.
